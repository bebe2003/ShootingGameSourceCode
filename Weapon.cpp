...
{
	// The parent version should be called as well, which will go ahead and get the rarity data table
	...
	if (WeaponTableObject)
	{
		...
		case EWeaponType::EWT_AssaultRife:
			WeaponDataRow = WeaponTableObject->FindRow<FWeaponDataTable>(FName("AssaultRife"), TEXT(""));
			break;
